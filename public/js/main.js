...
webrtc.addEventListener('grantAudioPermission', (e) => {
    ...
    if (videoContainer) {
        const audioPermissionBtn = videoContainer.querySelector('.permission_btn[data-type="audio"]');
...
webrtc.addEventListener('grantVideoPermission', (e) => {
    ...
    const videoContainer = document.getElementById(socketId);
    if (videoContainer) {
        const videoPermissionBtn = videoContainer.querySelector('.permission_btn[data-type="video"]');
